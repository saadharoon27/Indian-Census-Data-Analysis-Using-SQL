...
FROM 'D:\STUDY\Desktop Study\Portfolio\SQL\3. Indian Census Data Analysis\Dataset1.csv'
DELIMITER ','
CSV HEADER;

/*Importing data from the CSV file to the table 'Dataset2' */
COPY dataset2(district,state,area_km2,population)
FROM 'D:\STUDY\Desktop Study\Portfolio\SQL\3. Indian Census Data Analysis\Dataset2.csv'
DELIMITER ','
CSV HEADER;
